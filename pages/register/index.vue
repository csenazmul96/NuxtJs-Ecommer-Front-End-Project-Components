<template>
  <div class="header_account  header_registration_form">
  <div class="inner_form">
    <div class="container-fluid">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form_inline">
                <label class="required">Primary Customer Market *</label>
                <select class="form-control" v-model="form.primary_customer_market">
                ...
                <v-errors :errors="errorFor('primary_customer_market')"></v-errors>
                </div>
                <div class="inner_checkbox mb_20">
                <span class="pr_20">Do you sell online ?</span>
                <div class="custom_radio">
                    <input type="radio" id="sellOnlineYes" name="sellOnline" value="1" v-model="form.sell_online">
                    <label for="sellOnlineYes">Yes</label>
                </div>
                <div class="custom_radio">
                    <input type="radio" id="sellOnlineNo" name="sellOnline" value="0" v-model="form.sell_online">
                    <label for="sellOnlineNo">No</label>
                </div>

                <v-errors :errors="errorFor('sell_online')"></v-errors>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form_inline">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control" v-model="form.shipping_state_id">
                <option v-for="state in shippingStates" :value="state.id"> {{ state.name }}</option>
            </select>
        ...
        <div class="col-md-12">
            <div class="form_inline">
            <label>Fax</label>
            <input type="text" class="form-control" placeholder="" v-model="form.shipping_fax">
            </div>
        </div>
        <div class="col-md-12">
        ...
        <template v-if="!this.form.billing_to_shipping">
            ...
            <div class="form_inline" v-if="form.billing_location === 'US' || form.billing_location === 'CA'">
                ...
                <option v-for="state in billingStates" :value="state.id"> {{ state.name }}</option>
                </select>
            ...
            <div class="form_inline">
                <label>Fax</label>
                <input type="text" class="form-control" placeholder="" v-model="form.billing_fax">
                <v-errors :errors="errorFor('billing_fax')"></v-errors>
            </div>
            </div>
        </template>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <button class="btn_common width_200p mr_10" ><nuxt-link :to="{name:'login'}">Login</nuxt-link></button>
            <button class="btn_common width_200p ml_10" @click.prevent="register">Register <span v-show="loading"> <i class="fas fa-circle-notch fa-spin"></i></span></button>
            </div>
        </div>
        </div>
    </div>
  ...
  methods: {
    register() {
      ...
      if(this.form.billing_to_shipping){
        formData.append('billing_location',   this.form.shipping_location);
        formData.append('billing_store_no',   this.form.shipping_store_no);
        formData.append('billing_attention',  this.form.shipping_attention);
        formData.append('billing_unit',       this.form.shipping_unit);
        formData.append('billing_address',    this.form.shipping_address);
        formData.append('billing_city',       this.form.shipping_city);
        formData.append('billing_state_id',   this.form.shipping_state_id);
        formData.append('billing_state_text', this.form.shipping_state_text);
        formData.append('billing_zip',        this.form.shipping_zip);
        formData.append('billing_country_id', this.form.shipping_country_id);
        formData.append('billing_phone',      this.form.shipping_phone);
        formData.append('billing_fax',        this.form.shipping_fax);
        formData.append('billing_commercial', this.form.shipping_commercial);
      }
