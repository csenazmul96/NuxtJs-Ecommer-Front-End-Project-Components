  ...
  <div>
    <div class="form-row mb_10">
      <div class="col-md-4">
        <div class="custom_radio">
          <input type="radio" id="locationUS" name="location" @change="changeBillingLocation('US')" value="US" v-model="form.location">
          <label for="locationUS">United States</label>
        </div>
      </div>
      <div class="col-md-4">
        <div class="custom_radio">
          <input type="radio" id="locationCA" name="location" @change="changeBillingLocation('CA')" value="CA" v-model="form.location">
          <label for="locationCA">Canada</label>
        </div>
      </div>
      <div class="col-md-4">
        <div class="custom_radio">
          <input type="radio" id="locationINT" name="location" @change="changeBillingLocation('INT')" value="INT" v-model="form.location">
    ...
    <div class="form-row">
      <div class="form-group col-6">
        ...
        <v-errors :errors="errorFor('billing.address')"></v-errors>
      </div>
    ...
    <div class="form-row">
      <div class="form-group col-6">
        ...
        <v-errors :errors="errorFor('billing.city')"></v-errors>
      </div>
      <div class="form-group col-6" v-if="form.location === 'US' || form.location === 'CA'">
        ...
        <v-errors :errors="errorFor('billing.state_id')"></v-errors>
      </div>
      <div class="form-group col-6" v-else>
        ...
        <v-errors :errors="errorFor('billing.state_text')"></v-errors>
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group col-6">
        ...
        <v-errors :errors="errorFor('billing.zip')"></v-errors>
      </div>
      <div class="form-group col-6">
        ...
        <v-errors :errors="errorFor('billing.country_id')"></v-errors>
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group col-6">
        ...
        <v-errors :errors="errorFor('billing.phone')"></v-errors>
      </div>
      <div class="form-group col-6">
...
export default {
  ...
  computed: {
    ...mapGetters({
      billingAddress: 'checkoutModule/getBillingAddress',
    }),
  },
  watch: {
    form: {
      deep: true,
      handler() {
        this.$store.commit('checkoutModule/setBillingAddress', _.cloneDeep(this.form));
      }
    },
    errors:{
      deep: true,
